...
public class StudentController {
    ...
    public ResponseEntity<List<Student>> getMethodName(@RequestParam int pagetNo,@RequestParam int pageSize) {
        return new ResponseEntity<>(obj.Paging(pagetNo, pageSize),HttpStatus.OK);
    }
